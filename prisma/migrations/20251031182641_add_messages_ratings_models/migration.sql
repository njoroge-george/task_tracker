...
-- CreateEnum
CREATE TYPE "NotificationType" AS ENUM ('TASK_ASSIGNED', 'TASK_COMPLETED', 'TASK_DUE_SOON', 'COMMENT_ADDED', 'MENTION', 'PROJECT_INVITE', 'MESSAGE_RECEIVED', 'RATING_RECEIVED', 'SUBSCRIPTION_EXPIRING', 'SUBSCRIPTION_RENEWED');
