      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-start">
          <input
            ...
            type="checkbox"
            required
            className="w-4 h-4 mt-1 text-accent border-default rounded focus:ring-accent"
          />
          <label htmlFor="terms" className="ml-2 text-sm text-secondary">
            I agree to the{" "}
            <Link href="/terms" className="text-accent dark:text-purple-400 hover:underline">
              Terms of Service
            </Link>{" "}
            and{" "}
            <Link href="/privacy" className="text-accent dark:text-purple-400 hover:underline">
              Privacy Policy
            </Link>
          </label>
        </div>
